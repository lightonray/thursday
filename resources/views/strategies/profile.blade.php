                                ...
                                <div class="col-xl-5 col-lg-12 col-md-12">
                                    ...
                                    <div class="item-btns mt-30">
                                        <button id="startBotBtn" class="main-btn btn-hover h-40 w-100 mt-2 me_2"
                                            ...
                                            data-bot-id="{{ $strategy->id }}">Edit Strategy</button>
                                        <button id="stopBotBtn" class="buy-btn h-40 w-100 mt-2 ms_2" data-bs-toggle="modal"
                                            data-bs-target="#buyModal" data-bot-id="{{ $strategy->id }}">Remove Strategy</button>
                                    </div>
                                </div>
                                <div class="col-xl-7 col-lg-12 col-md-12">
                                    <div class="item-details rrrmt-30">
                                        <div class="item-dt-top">
                                            <h3 class="view-item-title">Strategy Name: {{ $strategy->name }}</h3>
                                                            ...
                                                            <ul class="about-item-dt">
                                                                <li>
                                                                    <div class="about-item-dt-list">
                                                                        <h4>Instrument</h4>
                                                                        <span>{{ $options['instrument'] ?? 'N/A' }}</span>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="about-item-dt-list">
                                                                        <h4>Position Type</h4>
                                                                        <span>{{ $options['position_type'] ?? 'N/A' }}</span>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="about-item-dt-list">
                                                                        <h4>Position Size</h4>
                                                                        <span>{{ $options['position_size'] ?? 'N/A' }}</span>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="about-item-dt-list">
                                                                        <h4>Entry Strategy</h4>
                                                                        <span>Type: {{ $options['entry_strategy']['type'] ?? 'N/A' }}, Price: {{ $options['entry_strategy']['entry_price'] ?? 'Market Price' }}</span>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="about-item-dt-list">
                                                                        <h4>Exit Strategy</h4>
                                                                        <span>Take Profit: {{ $options['exit_strategy']['take_profit']['price'] ?? 'N/A' }}, Stop Loss: {{ $options['exit_strategy']['stop_loss']['price'] ?? 'N/A' }}</span>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="about-item-dt-list">
                                                                        <h4>Leverage</h4>
                                                                        <span>{{ $options['leverage'] ?? 'N/A' }}</span>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                        </div>
