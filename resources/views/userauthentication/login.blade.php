								...
								<div class="col-lg-6">
									<div class="lr-right">
										<div class="sign-title">
											...
											<h2>Sign in</h2>
											<p>Your digital wallet with Google, Facebook, Twitter, Apple ID, LinkedIn</p>
										</div>
										...
										<div class="login-register-form">
											<form>
												...
												<button class="main-btn btn-hover w-100 h-40 mt-3" type="submit">Continue with Email</button>
											</form>
