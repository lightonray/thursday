                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-10">
                            <div class="banner-content text-center">
                                <h2 class="title">Discover the Next Big Opportunity: <br> <span>Our ICO is Live</span></h2>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-10">
                            <div class="contribution-title">
                                <h2 class="title"><span>$45,256,432</span> Contribution Receive</h2>
                            </div>
                            <div class="progress-wrap">
                                ...
                                <h6 class="progress-title"> 65 target raised <span>1 ETH = $1000 = 3177.38 CIC</span></h6>
                            </div>
                            <div class="contribution-btn">
                                <a href="contact.html" class="btn">Purchase a Token</a>
                                        ...
                                        <div class="accordion-item active">
                                            ...
                                            <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    <p>LessAccounting is 100% web-based, meaning it can be accessed from anywhere and there’s no software to install on your computer. You can easily use LessAccounting on your iPhone or any Android mobile device with our cloud accounting.</p>
                                                </div>
                                            </div>
                                        </div>
