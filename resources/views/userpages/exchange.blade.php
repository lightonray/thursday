...
<head>
    ...
    <title>Thursday - Smart Terminal</title>
        ...
        <div class="sidebar py-2 py-md-2 me-0 border-end">
            <div class="d-flex flex-column h-100">
                ...
                <ul class="menu-list flex-grow-1 mt-4 px-1">
                    ...
                    <li>
                        <a class="m-link active" href="exchange.html">
                            <svg xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" width="24px" height="24px" viewBox="0 0 38 38">
                    ...
                    <li>
                        <a class="m-link" href="market.html">
                    ...
                    <li>
                        <a class="m-link" href="future-trade.html">
                            <svg  xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" width="24px" height="24px" viewBox="0 0 64 64">
                    ...
                    <li>
                        <a class="m-link" href="battel.html">
                            <svg  xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" width="24px" height="24px" viewBox="0 0 64 64">
                    ...
                    <li class="collapsed">
                        ...
                        <ul class="sub-menu collapse" id="trade">
                            <li><a class="ms-link" href="convert-trade.html">Convert</a></li>
                            
                            <li><a class="ms-link" href="margin-trade.html">Margin</a></li>
                    ...
                    <li class="collapsed">
                        ...
                        <ul class="sub-menu collapse" id="finace">
                            <li><a class="ms-link" href="cryptoloan.html">Crypto Loan</a></li>
                            <li><a class="ms-link" href="cryptoonpay.html">Cryptoon Pay</a></li>
                    ...
                    <li class="collapsed">
                        ...
                        <ul class="sub-menu collapse" id="form">
                            ...
                            <li><a class="ms-link" href="form-inputmask.html">Inputmask Form</a></li>
                        </ul>
                    </li>
                    <li class="collapsed">
