    ...
    <div class="wrapper d-flex flex-column h-100">
        <div class="main-wrapper">
            <div class="theme-orange m-2" style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <button type="button" class="btn" style="margin-right: 20px; background-color:rgb(80, 101, 246); color:white" data-bs-toggle="modal" data-bs-target="#exchangeConnectorModal">
...
<!-- Modal -->
<div class="modal fade" id="exchangeConnectorModal" tabindex="-1" aria-labelledby="exchangeConnectorModalLabel" aria-hidden="true">
                ...
                <form id="connectorForm">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="exchange_name" name="exchange_name">
                            <option value="Teribit Test">Teribit Test</option>
